  ...
  #       🇮 🇹 🇳 🇦    🇰 🇾 🇺   🇸 🇵 🇾     🇰 🇷    🇷 🇭 🇪     🇭 🇴      🇸 🇭 🇦 🇦 🇩 🇮    🇰 🇷 🇳 🇮    🇭    🇰 🇾 🇦   🇧 🇸 🇩 🇰 
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid or event.query.user_id == id:  # pylint:disable=E0602
            ...
            Cobra = "Please get your own Userbot, and don't use mine for more info visit @DYNAMICUSERBOTSUPPORT!"
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid or event.query.user_id == id:  # pylint:disable=E0602
            ...
            await event.edit(buttons=dc)
              ...
              TheDYNAMIC = "Please get your own Userbot😁😁,for more info visit @DYNAMICUSERBOTSUPPORT! 😎😎"
 ...
 #hehehehehhehhehhehe   
    ...
    async def on_plug_in_callback_query_handler(event):
        if not event.query.user_id == bot.uid or event.query.user_id == id:
            atul= "Please get your own Userbot😁😁,for more info visit @DYNAMICUSERBOTSUPPORT! 😎😎"
