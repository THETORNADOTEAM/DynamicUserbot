...
from DYNAMIC.plugins.sql_helper.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
async def on_snip(event):
    ...
    if event.chat_id in last_triggered_filters:
        if name in last_triggered_filters[event.chat_id]:
            # avoid DYNAMIC spam
            # "I demand rights for us bots, we are equal to you humans." -Henri Koivuneva (t.me/DYNAMICTesting/2698)
            return False
