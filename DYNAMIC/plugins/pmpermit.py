...
from DYNAMIC import CUSTOM_PMPERMIT

PMPERMIT_PIC = os.environ.get("PMPERMIT_PIC", None)
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/b81f45859f9c1be8b84aa.jpg"
else:
    WARN_PIC = PMPERMIT_PIC

Custom = "**Protection By DYNAMIC Userbot**"
import asyncio
import io
import os
import DYNAMIC.plugins.sql_helper.pmpermit_sql as pmpermit_sql
...
if Var.PRIVATE_GROUP_ID is not None:
    ...
    async def do_pm_permit_action(chat_id, event):
        ...
        if PM_WARNS[chat_id] == 5:
            ...
            the_message += "⚡️Powered By [DYNAMIC_USERBOT](https://github.com/teamdynamic/dynamic-userbot.git)"
