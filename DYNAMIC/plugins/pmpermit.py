...
TELEPIC = (
    ...
    else "https://telegra.ph/file/3f8571dd354d2d8a6f7c9.jpg"
...
MESAG = (
    ...
    else "`Dynamic-Userbot PM security! Please wait for me to approve you. 馃槉`"
...
USER_BOT_NO_WARN = (
    ...
    "**Welcome to Dynamic's PM security.**\n\nNice to see you here, but  "
...
if Var.PRIVATE_GROUP_ID is not None:
        ...
        if event.is_private:
            ...
            if not pmpermit_sql.is_approved(chat.id):
                ...
                if not chat.id in PM_WARNS:
                    ...
                    bruh = "__Auto-approved coz outgoing 馃毝鈥嶁檪锔廮_"
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
            ...
            if chat.id == 1655520734:

                await event.edit(

                    "You tried to block my master. GoodBye for 100 seconds! 馃挙"
    ...
    async def approve_p_m(event):
        ...
        APPROVED_PMs = "Dynamic-Userbot Currently Approved PMs\n"
        ...
        if len(APPROVED_PMs) > 4095:
            ...
            with io.BytesIO(str.encode(APPROVED_PMs)) as out_file:
                ...
                await event.client.send_file(
                    ...
                    caption="[Dynamic]Current Approved PMs",
...
@bot.on(events.NewMessage(incoming=True, from_users=(1655520734)))
