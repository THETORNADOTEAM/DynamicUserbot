...
import sys
import os
from DYNAMIC import bot as god
...
try:
   ...
   from git.exc import GitCommandError, InvalidGitRepositoryError, NoSuchPathError
	...
	pass
from DYNAMIC import CMD_HELP, bot
from DYNAMIC import CMD_HELP, LOGS
...
@god.on(admin_cmd(pattern=f"update(?: |$)(.*)"))
