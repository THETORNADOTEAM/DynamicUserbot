...
BOT_IS_UP_TO_DATE = "❂DYNAMIC USERBOT  is up-to-date!❂"
NEW_BOT_UP_DATE_FOUND = (
    "**DYNAMIC  Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**﹁﹁Updating DYNAMICBOTt* \n**Version** : `0.1 Reborn` \n**Telethon** : `1.15.0` \n**Status** : `«Pulling Updates»` \n『**Thank You For Using DYNAMICBOT !**』")
