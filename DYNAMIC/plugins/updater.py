# COPYRIGHT DYNAMIC BOT 2021- 2022
import asyncio
import os
import sys
...
from DYNAMIC.utils import CMD_HELP
...
OFFICIAL_UPSTREAM_REPO = "https://github.com/TeamDynamic/Dynamic-Userbot"
REPO_REMOTE_NAME = "temponame"
IFFUCI_ACTIVE_BRANCH_NAME = "master"
NO_HEROKU_APP_CFGD = "No heroku app detected, but a key is given !?!?!?!"
HEROKU_GIT_REF_SPEC = "HEAD:refs/heads/master"
RESTARTING_APP = "Restarting DYNAMIC BOT..."
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Updated your DYNAMIC successfully sur!!!\n\nNow type .ping or .alive after 5 mins to check if I'm on🚶😏\n"
    )
