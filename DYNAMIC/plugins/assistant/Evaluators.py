...
async def _(event):
    ...
    boy = pro.id
    if event.sender_id == boy or event.sender_id == id or event.sender_id == 1742906647:
       pass
    else:
       return await event.reply("deploy your own assistant check @DynamicUserbotSupport")
