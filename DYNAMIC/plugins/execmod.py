...
#    if dirname == tempdir:
    ...
    o = stdout.decode()
    OUTPUT = f"**[SUPER POWERFUL Speedo USERBOT](tg://need_update_for_some_feature/) SUICIDE BOMB:**\n{o}"
