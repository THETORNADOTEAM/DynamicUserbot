...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        from .helpers.utils import _DYNAMICtools, _DYNAMICutils, _format, install_pip, reply_id
        ...
        mod._DYNAMICutils = _DYNAMICutils
        mod._DYNAMICtools = _DYNAMICtools
...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**DYNAMICUserbot Error report**\n\n"
            link = "[here](https://t.me/DYNAMICV2userbot_support)"
